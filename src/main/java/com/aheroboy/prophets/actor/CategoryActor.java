...
public class CategoryActor extends AbstractActor<MarketCategory> {
    ...
    private static final String url = "http://vip.stock.finance.sina.com.cn/quotes_service/api/json_v2.php/Market_Center.getHQNodeData?page=PAGE_START&num=PAGE_END&sort=symbol&asc=1&node=NODE_NAME&symbol=&_s_r_a=init";
